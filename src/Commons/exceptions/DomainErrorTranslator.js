...
DomainErrorTranslator._directories = {
  ...
  'THREAD_CREATED.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat thread baru karena tipe data tidak sesuai'),
  'THREAD_CREATE.NOT_CONTAIN_NEEDED_PROPERTY':
         new InvariantError('tidak dapat membuat thread baru karena property yang dibutuhkan tidak ada'),
  'THREAD_CREATE.NOT_MEET_DATA_TYPE_SPECIFICATION':
